...
| [An Agentic System for Rare Disease Diagnosis with Traceable Reasoning](https://arxiv.org/pdf/2506.20430) <br> _Preprint (arXiv 2506.20430)_ | Multiple rare disease datasets (~2,919 disease types; free-text, HPO terms, and VCF genomic files) | Host LLM (unnamed) with specialized agent servers (DeepRare framework) | <details><summary>View Insights</summary>- Introduces DeepRare: an agentic diagnostic system integrating 40+ expert tools and live medical knowledge bases <br> - Handles multi-modal clinical input (text, HPO, VCF), producing ranked diagnoses with traceable reasoning chains <br> - Achieves 57.18% average Recall@1 (23.79% higher than Reasoning LLM baseline); multi-modal Recall@1 reaches 70.60% vs Exomiser’s 53.20% <br> - 95.4% of reasoning chains validated by clinicians as medically sound; deployed as a real-world diagnostic web app </details> |
